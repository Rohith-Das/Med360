      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">Med360</span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Med360 is your trusted partner in healthcare, providing convenient and secure online consultations with qualified medical professionals. Your health, our priority.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">support@med360.com</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 Med360. All rights reserved. | Terms of Service | Privacy Policy
          </p>
        </div>
      </div>
    </footer>
